...
/**
 * Data Initializer for seeding development database
 * Follows Backend Code Standards - development data seeding
 */
@Component
    ...
    private void initializeCategories() {
        List<Category> categories = Arrays.asList(
            ...
            Category.builder()
                .name("Kids")
                .slug("kids")
                .description("Kids' fashion and apparel")
    ...
    private void initializeProducts() {
        ...
        List<Product> products = Arrays.asList(
            Product.builder()
                ...
                .description("A timeless classic white t-shirt made from premium cotton. Perfect for casual wear.")
                .price(new BigDecimal("29.00"))
                .originalPrice(new BigDecimal("39.00"))
            ...
            Product.builder()
                ...
                .description("Modern slim fit denim jeans with stretch comfort. Versatile for any occasion.")
            ...
            Product.builder()
                ...
                .description("Warm and stylish knit sweater for cooler days. Made from soft, breathable material.")
            ...
            Product.builder()
                ...
                .originalPrice(new BigDecimal("85.00"))
            ...
            Product.builder()
                ...
                .description("Comfortable cotton hoodie for kids. Easy to wash and durable.")
                .price(new BigDecimal("35.00"))
                .originalPrice(new BigDecimal("45.00"))
                .imageUrl("https://images.unsplash.com/photo-1519238263530-99bdd11df2ea?w=600&h=800&fit=crop")
                .category(kids)
            ...
            Product.builder()
                ...
                .description("Smart casual polo shirt in premium cotton pique fabric.")
                .price(new BigDecimal("45.00"))
                .originalPrice(new BigDecimal("55.00"))
                .imageUrl("https://images.unsplash.com/photo-1625910513413-5fc4e5e6726b?w=600&h=800&fit=crop")
                .category(men)
